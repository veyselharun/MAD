// You might notice the legalGuesses and legalWords lists only contain a few words. 
// The full lists combined have over 10,000 words and were omitted for brevity. 
// You don't need the full lists to continue the tutorial. When you're testing 
// your app, make sure to use the words from those lists.

// Alternatively, you can find the full lists in the following GitHub repository, 
// as well as instructions to import it into your project.
